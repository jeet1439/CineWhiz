          ...
          {user ? (
            <View className='flex-row items-center mb-6 gap-6'>
              ...
              <View className='flex-1 justify-center items-center mb-5'>
                <TouchableOpacity onPress={logout} className='mt-6 py-2 rounded'>
                  <Ionicons
                    name="log-out-outline"  size={22} color="#fff"
                  />
                </TouchableOpacity>
              </View>
            ...
            <Text className='text-lg text-red-600'>No user logged in</Text>
          )}
            ...
            >
              <View className="bg-black/10 rounded-lg overflow-hidden p-4 ">
                <Image
                  ...
                  resizeMode="cover"
                />
                <Text className="text-stone-100 text-xl mt-2 ">Stay Ahead in Tech</Text>
                <Text className="text-stone-300 ">Explore the latest in tech — from cutting-edge tools and coding tutorials to industry trends.</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <View className="bg-black/10 rounded-lg overflow-hidden p-4 ">
                <Image
                  ...
                  resizeMode="cover"
                />
                <Text className="text-stone-100 text-xl mt-2 ">Welcome to the Midnite Vibe</Text>
                <Text className="text-stone-300 ">Where night owls, party lovers, and thinkers connect — Midnite comes alive when the world sleeps.</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              <View className="bg-black/10 rounded-lg overflow-hidden p-4 ">
                <Image
                  ...
                  resizeMode="cover"
                />
                <Text className="text-stone-100 text-xl mt-2 ">Book Your Next Escape</Text>
                <Text className="text-stone-300 ">Book dream stays or become a host. Travel made easy, for guests and owners alike.</Text>
              </View>
            </TouchableOpacity>
